...
void game_voxels::populate(void)
{
    ...
    game_voxels::grass = voxel_def::construct("grass", VoxelType::Cube, false, false)
        ...
        .add_texture(VoxelFace::CubeBottom, "textures/voxel/dirt_01.png")
        .add_texture(VoxelFace::CubeBottom, "textures/voxel/dirt_02.png")
        .add_texture(VoxelFace::CubeBottom, "textures/voxel/dirt_03.png")
        .add_texture(VoxelFace::CubeBottom, "textures/voxel/dirt_04.png")
        .add_texture(VoxelFace::CubeTop, "textures/voxel/grass_01.png")
        .add_texture(VoxelFace::CubeTop, "textures/voxel/grass_02.png")
        .build();
    ...
    game_voxels::oak_log = voxel_def::construct("oak_log", VoxelType::Cube, false, false)
        ...
        .add_texture(VoxelFace::CubeBottom, "textures/voxel/oak_wood_top.png")
        .add_texture(VoxelFace::CubeTop, "textures/voxel/oak_wood_top.png")
        .build();
